...
public class DtlkAgence : IEquatable<DtwhLigneType>
{
    /// <summary>
    ...
    {
        return Id == other.Id && Nom == other.Nom && Url == other.Url && Timezone == other.Timezone && Langue == other.Langue && Telephone == other.Telephone;
    }
    ...
    /// </returns>
    public bool Equals(DtwhLigneType? other)
    {
        return other != null
               && Id == other.Code
               && Nom == other.Nom
